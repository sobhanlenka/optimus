...
class Filter(object):
    ...
    def filter_selection(self, optimus, conversation_id):
        """
        ...
        """
        return optimus.storage.base_query
...
class RepetitiveResponseFilter(Filter):
    ...
    def filter_selection(self, optimus, conversation_id):
        ...
        latest_response = optimus.storage.get_latest_response(conversation_id)
        if latest_response:
        ...
        query = optimus.storage.base_query.statement_text_not_in(
            text_of_recent_responses
        )
