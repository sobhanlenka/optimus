...
class StorageAdapter(object):
    ...
    def generate_base_query(self, optimus, session_id):
        """
        Create a base query for the storage adapter.
        """
        if self.adapter_supports_queries:
            for filter_instance in optimus.filters:
                self.base_query = filter_instance.filter_selection(optimus, session_id)
