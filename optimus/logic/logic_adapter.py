...
from optimus.adapters import Adapter
from optimus.utils import import_module
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, **kwargs):
        ...
        from optimus.comparisons import levenshtein_distance
        from optimus.response_selection import get_first_response
