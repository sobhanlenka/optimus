...
from optimus.constants import TAG_NAME_MAX_LENGTH, STATEMENT_TEXT_MAX_LENGTH
from optimus.ext.sqlalchemy_app.types import UnicodeString
from optimus.conversation import StatementMixin
...
class Statement(Base, StatementMixin):
    ...
    def get_statement(self):
        from optimus.conversation import Statement as StatementObject
        from optimus.conversation import Response as ResponseObject
