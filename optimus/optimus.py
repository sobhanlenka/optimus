...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'optimus.storage.SQLStorageAdapter')

        # These are logic adapters that are required for normal operation
        system_logic_adapters = kwargs.get('system_logic_adapters', (
            'optimus.logic.NoKnowledgeAdapter',
        ))

        logic_adapters = kwargs.get('logic_adapters', [
            'optimus.logic.BestMatch'
        ])

        input_adapter = kwargs.get('input_adapter', 'optimus.input.VariableInputTypeAdapter')

        output_adapter = kwargs.get('output_adapter', 'optimus.output.OutputAdapter')
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'optimus.preprocessors.clean_whitespace'
            ]
        )
        ...
        trainer = kwargs.get('trainer', 'optimus.trainers.Trainer')
